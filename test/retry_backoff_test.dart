import 'package:flutter_dio_queue/src/backoff.dart';
...
void main() {
  test('backoff grows', () {
    final policy =
        RetryPolicy(baseDelay: const Duration(milliseconds: 10), jitter: 0);
  ...
  test('jitter range', () {
    final policy =
        RetryPolicy(baseDelay: const Duration(milliseconds: 100), jitter: 0.5);
